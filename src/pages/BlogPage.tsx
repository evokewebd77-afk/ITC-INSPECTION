    ...
    <main style={{ paddingTop: '80px', backgroundColor: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <section style={{ backgroundColor: 'var(--primary-color)', padding: '6rem 0', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 style={{ fontSize: '3.5rem', marginBottom: '1rem', fontWeight: 800 }}>Insights & News</h1>
      ...
      <section className="section" ref={ref as any}>
        <div className="container">
          <div className={`reveal-hidden ${isVisible ? 'reveal-visible' : ''}`} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
            {posts.map((post, idx) => (

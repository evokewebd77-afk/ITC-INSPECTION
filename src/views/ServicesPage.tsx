    ...
    <main style={{ paddingTop: '80px', backgroundColor: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <section style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', marginBottom: '1.5rem', fontWeight: 800, textShadow: '0 4px 20px rgba(0,0,0,0.5)', color: 'white' }}>Our Inspection Services</h1>
      ...
      <section style={{ backgroundColor: '#e3f2fd', padding: '6rem 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <Link href="/contact" className="btn btn-primary" style={{ padding: '1rem 3.5rem', fontSize: '1.25rem', display: 'inline-flex', alignItems: 'center', gap: '0.75rem', fontWeight: 700, borderRadius: '50px' }}>

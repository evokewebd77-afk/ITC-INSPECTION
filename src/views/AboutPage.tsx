    ...
    <main style={{ paddingTop: '80px', backgroundColor: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <section style={{ backgroundColor: '#e3f2fd', padding: '6rem 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <Link href="/contact" className="btn btn-primary" style={{ padding: '1rem 3rem', fontSize: '1.2rem', display: 'inline-flex', alignItems: 'center', gap: '0.75rem', fontWeight: 700, borderRadius: '50px' }}>
